...
class ConfiguracionModel extends StatefulWidget {
  const ConfiguracionModel({
    Key key,
  }) : super(key: key);

  @override
  _ConfiguracionModelState createState() => _ConfiguracionModelState();
}

class _ConfiguracionModelState extends State<ConfiguracionModel> {
  int cantContactos = 3;
  int tiempoNotificacion = 2;
  @override
